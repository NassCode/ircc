...
const initialForm = {
  ...
  application: { type: 'Visitor visa', number: '', uci: '', purpose: '', submittedAt: '', status: 'Application received' },
};
    ...
    <main id="wb-cont" className="container portal-main narrow-main admin-editor">
      ...
      <form onSubmit={submit}>
        ...
        <section className="portal-card admin-form-section"><h2>Assigned application</h2><div className="admin-form-grid">
          <Field label="Application type"><input required list="application-types" value={form.application.type} onChange={(e) => setNested('application', 'type', e.target.value)} /><datalist id="application-types"><option value="Visitor visa" /><option value="Study permit" /><option value="Work permit" /></datalist></Field>
