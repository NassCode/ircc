...
export function Profile() {
  ...
  </div><section className="inline-alert neutral"><strong>Need to report a change?</strong><span>Contact the administrator responsible for this demonstration account.</span></section></main>;
}
